...
app.css.append_css({
    'external_url': 'https://fonts.googleapis.com/css2?family=Space+Grotesk&display=swap',

})

# Create an app layout
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                        style={'textAlign': 'center', 'color': '#ec1045',
                                               'font-family': 'Space Grotesk', 'font-size': 35}),
